...
from .forms import UserOurRegistraion, ProfileImage, UserUpdateForm, UserLoginForm
...
def user_login(request):
    if request.method == 'POST':
        ...
        form = UserLoginForm()
    return render(request, 'users/user.html', {'form': form, 'title': 'Авторизация на сайте'})
...
def register(request):
    ...
    return render(request, 'users/registraion.html', {'form': form, 'title': 'Регистрация на сайте'})
